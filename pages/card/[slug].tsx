  ...
  if (error || !cardData) {
    return (
      <div style={styles.errorContainer}>
        ...
        <a href="https://tavvy.com" style={styles.errorLink}>Go to Tavvy</a>
      </div>
    );
  }
      ...
      <div style={styles.page}>
        ...
        <div style={styles.poweredBy}>
          ...
          <a href="https://tavvy.com" style={styles.tavvyLink}>
            <img src="/tavvy-logo.png" alt="Tavvy" style={styles.tavvyLogo} />
          </a>
          ...
          <div style={styles.appButtons}>
            ...
            >
              <img src="/app-store-badge.svg" alt="Download on App Store" style={styles.appBadge} />
            </a>
            <a 
              ...
              style={styles.appButton}
            >
              <img src="/google-play-badge.svg" alt="Get it on Google Play" style={styles.appBadge} />
            </a>
          </div>
        </div>
      </div>
