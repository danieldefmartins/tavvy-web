...
const QUICK_CATEGORIES = [
  ...
  { id: 'gas', name: 'Gas Stations', icon: '⛽', color: '#8A05BE' },
  { id: 'grocery', name: 'Grocery', icon: '🛒', color: '#00C2CB' },
  { id: 'pharmacy', name: 'Pharmacy', icon: '💊', color: '#8A05BE' },
  { id: 'atm', name: 'ATMs', icon: '🏧', color: '#06B6D4' },
  { id: 'parking', name: 'Parking', icon: '🅿️', color: '#6366F1' },
  { id: 'hotels', name: 'Hotels', icon: '🏨', color: '#EC4899' },
  { id: 'gyms', name: 'Gyms', icon: '💪', color: '#00C2CB' },
  { id: 'hospitals', name: 'Hospitals', icon: '🏥', color: '#DC2626' },
  { id: 'banks', name: 'Banks', icon: '🏦', color: '#059669' },
  { id: 'laundry', name: 'Laundry', icon: '🧺', color: '#8A05BE' },
