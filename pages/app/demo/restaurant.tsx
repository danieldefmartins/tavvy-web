...
export default function DemoRestaurant() {
  ...
  const config: PlaceConfig = {
    ...
    info: [
      { icon: '🕒', main: 'Lunch & dinner · See weekly hours', hours: [['Monday', 'Closed'], ['Tuesday', '12–3 PM · 5–10 PM'], ['Wednesday', '12–3 PM · 5–10 PM'], ['Thursday', '12–3 PM · 5–10 PM'], ['Friday', '12–3 PM · 5–11 PM'], ['Saturday', '12–11 PM'], ['Sunday', '12–9 PM']] },
      ...
      { icon: '🌿', main: 'Vegetarian options · Ask about dietary needs' },
    ],
    ...
    overviewContent: <div className="tavvy-demo-next"><Link href={DEMO_CARD}>Our digital business card ↗</Link><Link href={DEMO_GUIDE}>See what Tavvy can do for your restaurant ↗</Link></div>,
  };
  return <><Head><title>Trattoria Tavvy · The complete Tavvy restaurant demo</title><meta name="robots" content="noindex,nofollow" /><meta name="description" content="Explore the complete Tavvy restaurant experience: food, stories, a visual menu, eCard and table ordering." /></Head>
    ...
    {reviewOpen && <DemoReview onClose={() => setReviewOpen(false)} onSave={review => { recordDemoEvent('reviews'); setYourReview(review); try { localStorage.setItem(DEMO_REVIEW_KEY, JSON.stringify(review)); } catch {} setReviewOpen(false); setMessage('Your taps are now reflected in the four review tiles.'); }} />}
