    ...
    <>
      ...
      <AppLayout hideNav>
        <div style={{minHeight:'100vh',background:'linear-gradient(180deg, #0A0A0F 0%, #0F1520 50%, #1A2535 100%)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px',textAlign:'center'}}>
          <div style={{width:'100px',height:'100px',borderRadius:'50px',background:'linear-gradient(135deg, #00C2CB 0%, #059669 100%)',display:'flex',alignItems:'center',justifyContent:'center',marginBottom:'32px'}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'16px',width:'100%',maxWidth:'300px'}}>
            <button onClick={() => router.push('/app/realtors', undefined, { locale })} style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',background:'linear-gradient(90deg, #8A05BE 0%, #2563EB 100%)',color:'#FFFFFF',fontSize:'16px',fontWeight:600,padding:'16px',border:'none',borderRadius:'12px',cursor:'pointer'}}>
